...
func (w Walking) Calories() float64 {
	var calories float64 = ((CaloriesWeightMultiplier*w.Weight +
		(math.Pow(w.Training.meanSpeed()*KmHInMsec, 2)/(w.Height/100))*
			CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Duration.Hours() * MinInHours)
	return calories
}
...
func (s Swimming) Calories() float64 {
	var calories float64 = (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) *
